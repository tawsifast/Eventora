...
export const Route = createFileRoute("/_public/orders")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Review every EventHub ticket order, payment status and receipt in one place." },
      { property: "og:title", content: "Order History — EventHub" },
      { property: "og:description", content: "All your ticket purchases and receipts." },
    ],
  }),
...
function OrdersPage() {
  const all = getOrdersByCustomer(currentUser.id);
      ...
      <PageHeader
        ...
        action={
          <Button asChild variant="outline">
            <Link to="/tickets">Open ticket wallet</Link>
          </Button>
        }
      />
