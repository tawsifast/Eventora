...
export const Route = createFileRoute("/_public/events/$eventId")({
  loader: ({ params }) => {
    const event = events.find((e) => e.slug === params.eventId || e.id === params.eventId);
  ...
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        {
          name: "description",
          content: `${event.shortDescription} ${event.venue}, ${event.city}. Get your tickets on EventHub.`,
        },
  ...
  notFoundComponent: () => (
    <div className="mx-auto max-w-xl px-4 py-24 text-center">
      ...
      <p className="mt-3 text-muted-foreground">This event may have ended or been removed.</p>
  ...
  errorComponent: () => (
    <div className="mx-auto max-w-xl px-4 py-24 text-center">
      <h1 className="text-4xl">This event didn't load</h1>
      <Button asChild className="mt-6">
